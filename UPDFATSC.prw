...
ฑฑบPrograma  ณ UPDFATSC บAutor  ณDanilo Jos้ Grodzickiบ Dataณ  11/08/2016 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Compatibilizador para Fatura Schedule.                     บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
aAdd( aSX2, { ;
	...
	'LOG Fatura Schedule'		   					, ;  // X2_NOME
	'LOG Fatura Schedule'							, ;  // X2_NOMESPA
	'LOG Fatura Schedule'  							, ;  // X2_NOMEENG
	''							    					, ;  // X2_ROTINA
	'C'							    					, ;  // X2_MODO
	'C'							    					, ;  // X2_MODOUN
	'C'							  		  				, ;  // X2_MODOEMP
...
aAdd( aSX2, { ;
	...
	'LOG Itens Fatura Schedule'	   					, ;  // X2_NOME
	'LOG Itens Fatura Schedule'						, ;  // X2_NOMESPA
	'LOG Itens Fatura Schedule' 					, ;  // X2_NOMEENG
	''							    					, ;  // X2_ROTINA
	'C'							    					, ;  // X2_MODO
	'C'							    					, ;  // X2_MODOUN
	'C'							  		  				, ;  // X2_MODOEMP
...
aAdd( aSX3, { ;
	...
	'No. Fatura'											, ;  // X3_TITSPA
	'No. Fatura'											, ;  // X3_TITENG
	'Numero da Fatura'									, ;  // X3_DESCRIC
	'Numero da Fatura'									, ;  // X3_DESCSPA
	'Numero da Fatura'									, ;  // X3_DESCENG
	'@!'													, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZB4'																												, ; //INDICE
	'1'																													, ; //ORDEM
	'ZB4_FILIAL+ZB4_PREFIX+ZB4_NNUM+ZB4_PARCEL+ZB4_TIPO'															, ; //CHAVE
...
aAdd( aSIX, { ;
	'ZB4'																												, ; //INDICE
	'2'																													, ; //ORDEM
	'ZB4_FILIAL+DTOS(ZB4_DTGERA)+ZB4_HRGERA+ZB4_PREFIX+ZB4_NNUM+ZB4_PARCEL+ZB4_TIPO'							, ; //CHAVE
	'Dt. Geracao + Hr. Geracoa + Prefixo + No. Titulo + Parcela + Tipo'										, ; //DESCRICAO
	'Dt. Geracao + Hr. Geracoa + Prefijo + Num. Titulo + Cuota + Tipo'											, ; //DESCSPA
	'Dt. Geracao + Hr. Geracoa + Prefix + Bill Number + Installment + Type'									, ; //DESCENG
	'U'																													, ; //PROPRI
	''																													, ; //F3
	'ZB40000002'																										, ; //NICKNAME
	'S'																													} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'ZB5'																												, ; //INDICE
	'1'																													, ; //ORDEM
	'ZB5_FILIAL+ZB5_TITPRE+ZB5_TITNNU+ZB5_TITPAR+ZB5_TITTIP+ZB5_PREFIX+ZB5_NNUM+ZB5_PARCEL+ZB5_TIPO'		, ; //CHAVE
	'Prefixo Tit. + No. Titulo Tit. + Parcela Tit. + Tipo Tit. + Prefixo + No. Titulo + Parcela + Tipo'	, ; //DESCRICAO
	'Prefixo Tit. + No. Titulo Tit. + Parcela Tit. + Tipo Tit. + Prefixo + No. Titulo + Parcela + Tipo'	, ; //DESCSPA
	'Prefixo Tit. + No. Titulo Tit. + Parcela Tit. + Tipo Tit. + Prefixo + No. Titulo + Parcela + Tipo'	, ; //DESCENG
	'U'																													, ; //PROPRI
	''																													, ; //F3
	'ZB50000001'																										, ; //NICKNAME
	'S'																													} ) //SHOWPESQ
...
aAdd( aSX6, { ;
	...
	'MV_XPORTAD'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Banco utilizado no fatura schedule'								, ; //X6_DESCRIC
	'Banco utilizado no fatura schedule'								, ; //X6_DSCSPA
	'Banco utilizado no fatura schedule'								, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'MV_XAGENCI'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Ag๊ncia utilizada no fatura schedule'								, ; //X6_DESCRIC
	'Ag๊ncia utilizada no fatura schedule'								, ; //X6_DSCSPA
	'Ag๊ncia utilizada no fatura schedule'								, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'MV_XCONCOR'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Conta corrente utilizada no fatura schedule'						, ; //X6_DESCRIC
	'Conta corrente utilizada no fatura schedule'						, ; //X6_DSCSPA
	'Conta corrente utilizada no fatura schedule'						, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'MV_XEXTBOL'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Diretorio grava extrato boleto.'									, ; //X6_DESCRIC
	'Diretorio grava extrato boleto.'									, ; //X6_DSCSPA
	'Diretorio grava extrato boleto.'									, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
