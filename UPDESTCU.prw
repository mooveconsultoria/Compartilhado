...
ฑฑบPrograma  ณ UPDESTCU บAutor  ณDanilo Jos้ Grodzickiบ Dataณ  31/03/2016 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Compatibilizador para tela Alterar Meter.                  บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
aAdd( aSX2, { ;
	...
	'LOG Altera็ใo Meter'		   					, ;  // X2_NOME
	'LOG Altera็ใo Meter'							, ;  // X2_NOMESPA
	'LOG Altera็ใo Meter'  							, ;  // X2_NOMEENG
	''							    					, ;  // X2_ROTINA
	'E'							    					, ;  // X2_MODO
	'E'							    					, ;  // X2_MODOUN
	'E'							  		  				, ;  // X2_MODOEMP
...
aAdd( aSX2, { ;
	...
	'Bombeio X NF Entrada'		   					, ;  // X2_NOME
	'Bombeio X NF Entrada'							, ;  // X2_NOMESPA
	'Bombeio X NF Entrada'  							, ;  // X2_NOMEENG
	''							    					, ;  // X2_ROTINA
	'E'							    					, ;  // X2_MODO
	'E'							    					, ;  // X2_MODOUN
	'E'							  		  				, ;  // X2_MODOEMP
...
aAdd( aSX3, { ;
	...
	'Meter Ant.'											, ;  // X3_TITSPA
	'Meter Ant.'											, ;  // X3_TITENG
	'Meter Anterior'										, ;  // X3_DESCRIC
	'Meter Anterior'										, ;  // X3_DESCSPA
	'Meter Anterior'										, ;  // X3_DESCENG
...
aAdd( aSX3, { ;
	...
	11														, ;  // X3_TAMANHO
	0														, ;  // X3_DECIMAL
	'Meter Atual'											, ;  // X3_TITULO
	'Meter Atual'											, ;  // X3_TITSPA
	'Meter Atual'											, ;  // X3_TITENG
	'Meter Atual'											, ;  // X3_DESCRIC
	'Meter Atual'											, ;  // X3_DESCSPA
	'Meter Atual'											, ;  // X3_DESCENG
	'@E 99,999,999,999'									, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Dt. Altera'											, ;  // X3_TITSPA
	'Dt. Altera'											, ;  // X3_TITENG
	'Data Altera็ใo'										, ;  // X3_DESCRIC
	'Data Altera็ใo'										, ;  // X3_DESCSPA
	'Data Altera็ใo'										, ;  // X3_DESCENG
	''														, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Hr. Altera'											, ;  // X3_TITSPA
	'Hr. Altera'											, ;  // X3_TITENG
	'Hr. Alteracao'										, ;  // X3_DESCRIC
	'Hr. Alteracao'										, ;  // X3_DESCSPA
	'Hr. Alteracao'										, ;  // X3_DESCENG
	'99:99:99'												, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Numero de Documento/Fact.'							, ;  // X3_DESCSPA
...
aAdd( aSX3, { ;
	...
	'Prov/Cliente'										, ;  // X3_TITSPA
	'Sup/Cust'												, ;  // X3_TITENG
	'Codigo do Forn/Cliente'								, ;  // X3_DESCRIC
	'Codigo de Prov/Cliente'								, ;  // X3_DESCSPA
...
aAdd( aSX3, { ;
	...
	'Tienda de Prov/Cliente'								, ;  // X3_DESCSPA
	'Supplier/Customer Store'							, ;  // X3_DESCENG
	'@!'													, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	9														, ;  // X3_TAMANHO
	0														, ;  // X3_DECIMAL
	'Cod. Bombeio'										, ;  // X3_TITULO
	'Cod. Bombeio'										, ;  // X3_TITSPA
	'Cod. Bombeio'										, ;  // X3_TITENG
	'Codigo do Bombeio'									, ;  // X3_DESCRIC
	'Codigo do Bombeio'									, ;  // X3_DESCSPA
	'Codigo do Bombeio'									, ;  // X3_DESCENG
	'@!'													, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Data Inclusใo'										, ;  // X3_DESCRIC
	'Data Inclusใo'										, ;  // X3_DESCSPA
	'Data Inclusใo'										, ;  // X3_DESCENG
	''														, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Hr. Inclusao'										, ;  // X3_TITSPA
	'Hr. Inclusao'										, ;  // X3_TITENG
	'Hr. Inclusใo'										, ;  // X3_DESCRIC
	'Hr. Inclusใo'										, ;  // X3_DESCSPA
	'Hr. Inclusใo'										, ;  // X3_DESCENG
	'99:99:99'												, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZC6'												, ; //INDICE
	'1'													, ; //ORDEM
	'ZC6_FILIAL+ZC6_LOCAL+ZC6_LOCALI'				, ; //CHAVE
	'Filial + Local + Endere็o'						, ; //DESCRICAO
	'Filial + Local + Endere็o'						, ; //DESCSPA
	'Filial + Local + Endere็o'						, ; //DESCENG
	'U'													, ; //PROPRI
	''													, ; //F3
	'ZC60000001'										, ; //NICKNAME
	'S'													} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'ZC7'																			 , ; //INDICE
	'1'																				 , ; //ORDEM
	'ZC7_FILIAL + ZC7_DOC + ZC7_SERIE + ZC7_FORNEC + ZC7_LOJA + ZC7_BOMBEI', ; //CHAVE
	'Filial + Documento + S้rie + Fornecedor + Loja + Bombeio'				 , ; //DESCRICAO
	'Filial + Documento + S้rie + Fornecedor + Loja + Bombeio'				 , ; //DESCSPA
	'Filial + Documento + S้rie + Fornecedor + Loja + Bombeio'				 , ; //DESCENG
	'U'																			 	 , ; //PROPRI
	''																				 , ; //F3
	'ZC70000001'																	 , ; //NICKNAME
	'S'																				 } ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'ZC7'																			 , ; //INDICE
	'2'																				 , ; //ORDEM
	'ZC7_FILIAL + ZC7_BOMBEI + ZC7_DOC + ZC7_SERIE + ZC7_FORNEC + ZC7_LOJA', ; //CHAVE
	'Filial + Bombeio + Documento + S้rie + Fornecedor + Loja'				 , ; //DESCRICAO
	'Filial + Bombeio + Documento + S้rie + Fornecedor + Loja'				 , ; //DESCSPA
	'Filial + Bombeio + Documento + S้rie + Fornecedor + Loja'				 , ; //DESCENG
	'U'																				 , ; //PROPRI
	''																				 , ; //F3
	'ZC70000002'																	 , ; //NICKNAME
	'S'																				 } ) //SHOWPESQ
