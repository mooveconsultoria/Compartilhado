...
ฑฑบPrograma  ณ UPDTABDE บAutor  ณDanilo Jos้ Grodzickiบ Dataณ  10/10/2016 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Compatibilizador para: - Tabale de desconto por cliente.   บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
aAdd( aSX2, { ;
	...
	'Cab Tabela Percentual Desconto'				, ;  // X2_NOME
	'Cab Tabela Percentual Desconto'				, ;  // X2_NOMESPA
	'Cab Tabela Percentual Desconto'				, ;  // X2_NOMEENG
	''							    					, ;  // X2_ROTINA
	'C'							    					, ;  // X2_MODO
	'C'							    					, ;  // X2_MODOUN
	'C'							  		  				, ;  // X2_MODOEMP
...
aAdd( aSX2, { ;
	...
	'Item Tabela Percentual Desconto'				, ;  // X2_NOME
	'Item Tabela Percentual Desconto'				, ;  // X2_NOMESPA
	'Item Tabela Percentual Desconto'				, ;  // X2_NOMEENG
	''							    					, ;  // X2_ROTINA
	'C'							    					, ;  // X2_MODO
	'C'							    					, ;  // X2_MODOUN
	'C'							  		  				, ;  // X2_MODOEMP
...
aAdd( aSX3, { ;
	...
	'GETSXENUM("ZA2","ZA2_CODTAB")'						, ;  // X3_RELACAO
	''														, ;  // X3_F3
	1														, ;  // X3_NIVEL
	Chr(254) + Chr(192)									, ;  // X3_RESERV
	''														, ;  // X3_TRIGGER
...
aAdd( aSX3, { ;
	...
	'Hora da Inclusao'									, ;  // X3_DESCRIC
	'Hora da Inclusao'									, ;  // X3_DESCSPA
	'Hora da Inclusao'									, ;  // X3_DESCENG
	''														, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Tab. Ativa ?'										, ;  // X3_TITSPA
	'Tab. Ativa ?'										, ;  // X3_TITENG
	'Tab. Ativa ?'										, ;  // X3_DESCRIC
	'Tab. Ativa ?'										, ;  // X3_DESCSPA
	'Tab. Ativa ?'										, ;  // X3_DESCENG
	'@!'													, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	08														, ;  // X3_TAMANHO
	0														, ;  // X3_DECIMAL
	'Dt.Inativa?'											, ;  // X3_TITULO
	'Dt.Inativa?'											, ;  // X3_TITSPA
	'Dt.Inativa?'											, ;  // X3_TITENG
	'Data inativacao'										, ;  // X3_DESCRIC
	'Data inativacao'										, ;  // X3_DESCSPA
	'Data inativacao'										, ;  // X3_DESCENG
	''														, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	02														, ;  // X3_TAMANHO
	0														, ;  // X3_DECIMAL
	'Hr.Inativa ?'										, ;  // X3_TITULO
	'Hr.Inativa ?'										, ;  // X3_TITSPA
	'Hr.Inativa ?'										, ;  // X3_TITENG
	'Hora da inativacao'									, ;  // X3_DESCRIC
	'Hora da inativacao'									, ;  // X3_DESCSPA
	'Hora da inativacao'									, ;  // X3_DESCENG
	''														, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'R'														, ;  // X3_CONTEXT
	Chr(128)												, ;  // X3_OBRIGAT
	'EXISTCPO("SA1",M->ZA1_CLIENT)'						, ;  // X3_VLDUSER
	''														, ;  // X3_CBOX
	''														, ;  // X3_CBOXSPA
	''														, ;  // X3_CBOXENG
	''														, ;  // X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'Perc. Desc.'											, ;  // X3_TITSPA
	'Perc. Desc.'											, ;  // X3_TITENG
	'Percentual Desconto'								, ;  // X3_DESCRIC
	'Percentual Desconto'								, ;  // X3_DESCSPA
	'Percentual Desconto'								, ;  // X3_DESCENG
	'@E 999.99'											, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Obs. Linha'											, ;  // X3_TITSPA
	'Obs. Linha'											, ;  // X3_TITENG
	'Obs. Linha'											, ;  // X3_DESCRIC
	'Obs. Linha'											, ;  // X3_DESCSPA
	'Obs. Linha'											, ;  // X3_DESCENG
	''														, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZA2'																													, ; //INDICE
	'1'																														, ; //ORDEM
	'ZA2_FILIAL+ZA2_CODTAB+ZA2_REV+ZA2_CODPRO'																		, ; //CHAVE
	'Filial+Cod. Tabela+Revisao+Cod. Produto'																			, ; //DESCRICAO
	'Filial+Cod. Tabela+Revisao+Cod. Produto'																			, ; //DESCSPA
	'Filial+Cod. Tabela+Revisao+Cod. Produto'																			, ; //DESCENG
	'U'																														, ; //PROPRI
	''																														, ; //F3
	'ZA20000001'																											, ; //NICKNAME
	'S'																														} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'ZA2'																													, ; //INDICE
	'2'																														, ; //ORDEM
	'ZA2_FILIAL+ZA2_CODPRO+ZA2_ATIVA'																					, ; //CHAVE
	'Cod. Produto+Tab. Ativa ?'																							, ; //DESCRICAO
	'Cod. Produto+Tab. Ativa ?'																							, ; //DESCSPA
	'Cod. Produto+Tab. Ativa ?'																							, ; //DESCENG
	'U'																														, ; //PROPRI
	''																														, ; //F3
	'ZA20000002'																											, ; //NICKNAME
	'S'																														} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'ZA3'																													, ; //INDICE
	'1'																														, ; //ORDEM
	'ZA3_FILIAL+ZA3_CODTAB+ZA3_REV+ZA3_BASE+ZA3_CLIENT+ZA3_LOJA'													, ; //CHAVE
	'Cod. Tabela+Revisao+Base/Filial+Cliente+Loja'																	, ; //DESCRICAO
	'Cod. Tabela+Revisao+Base/Filial+Cliente+Loja'																	, ; //DESCSPA
	'Cod. Tabela+Revisao+Base/Filial+Cliente+Loja'																	, ; //DESCENG
	'U'																														, ; //PROPRI
	''																														, ; //F3
	'ZA30000001'																											, ; //NICKNAME
	'S'																														} ) //SHOWPESQ
...
aAdd( aSX7, { ;
	...
	'ZA2_DESCPR'																			, ; //X7_CDOMIN
	'P'																						, ; //X7_TIPO
	'S'																						, ; //X7_SEEK
	'SB1'																					, ; //X7_ALIAS
	1																						, ; //X7_ORDEM
	'XFILIAL("SB1")+M->ZA2_CODPRO'														, ; //X7_CHAVE
	'U'																						, ; //X7_PROPRI
	''																						} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	...
	'ZA3_NOMCLI'																			, ; //X7_CDOMIN
	'P'																						, ; //X7_TIPO
	'S'																						, ; //X7_SEEK
	'SA1'																					, ; //X7_ALIAS
	1																						, ; //X7_ORDEM
	'XFILIAL("SA1")+M->ZA3_CLIENT+M->ZA3_LOJA'										, ; //X7_CHAVE
	'U'																						, ; //X7_PROPRI
	''																						} ) //X7_CONDIC
